...
class TQ(PluginInterface):
    ...
    hooks = {PacketTypes.PlayerText, PacketTypes.Update,
             PacketTypes.GotoAck, PacketTypes.UseItem}
    load = True
    defaultState = True
    ...
    def onPlayerText(self, client: Client, packet: PlayerText, send: bool) -> (PlayerText, bool):
        if packet.text.lower() == "/tq":
            if client.latestQuest != None:
                ...
                client.createNotification(
                    "TeleportTools", "Teleport to quest by using your ability")
            else:
                client.createNotification(
                    "TeleportTools", "No quest registered")
            send = False
        ...
        # Garden
            ...
            if client.currentMap == "Garden of Chaos":
                ...
                client.createNotification(
                    "TeleportTools", "Teleport to position by using your ability")
            else:
                client.createNotification(
                    "TeleportTools", "You can only use this command in a Garden of Chaos!")
            send = False
        ...
        # Illu
            ...
            if client.currentMap == "Crypt of the Illusionist":
                ...
                client.createNotification(
                    "TeleportTools", "You can only use this command in a Crypt of the Illusionist")
            send = False
        ...
        # Shatters
            ...
            if client.currentMap == "The Shatters":
                ...
                client.createNotification(
                    "TeleportTools", "You can only use this command in The Shatters")
            send = False
        ...
        # Rift
            ...
            if client.currentMap == "Ascended Rift":
                ...
                client.createNotification(
                    "TeleportTools", "You can only use this command in an Ascended Rift")
            send = False
